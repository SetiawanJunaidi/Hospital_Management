...
namespace HospitalManagementSystemCSharp
{
    public partial class StaffInformation : Form
    {
        ...
        {
            //MySqlConnection con = new MySqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\SmartCity\Downloads\HospitalManagementSystem_C#\HospitalManagementSystemCSharp\HospitalManagementSystemCSharp\hospital.mdf;Integrated Security=True");
            string mysqlcon = "server=localhost;user=root;database=hospital;password=";
            MySqlConnection mySqlConnection = new MySqlConnection(mysqlcon);
            mySqlConnection.Open();
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    ...
                    textBox6.Text = "";
                    textBox7.Text = "";
                    //using (MySqlConnection mySqlConnection1 = new MySqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\SmartCity\Downloads\HospitalManagementSystem_C#\HospitalManagementSystemCSharp\HospitalManagementSystemCSharp\hospital.mdf;Integrated Security=True"))
                    
                    MySqlConnection MySqlConnection = new MySqlConnection(mysqlcon);
                    {

                        string str2 = "SELECT * FROM staff";
                        MySqlCommand cmd2 = new MySqlCommand(str2, mySqlConnection);
                        MySqlDataAdapter da = new MySqlDataAdapter(cmd2);
                        DataTable dt = new DataTable();
                        da.Fill(dt);
                        dataGridView1.DataSource = new BindingSource(dt, null);
